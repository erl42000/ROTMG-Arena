...
while not ended:
    ...
    for projectile in projectileList:
        ...
        elif hitbox.colliderect(characterXYHitbox) and character.hp > 0 and projectile.alignment == 1:
    ...
    #Changes sprite to correct movement sprite
        ...
        if keyDown[pygame.K_w]:
            ...
            characterDirection[1] -= 1

        if keyDown[pygame.K_s]:

            characterDirection[1] += 1

        if characterDirection[0] == 1:

            character.rightWalk()

        elif characterDirection[0] == -1:

            character.leftWalk()

        elif characterDirection[1] == -1:
